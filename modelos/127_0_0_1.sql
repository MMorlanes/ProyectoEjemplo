...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-10-2024 a las 12:17:44
...
CREATE TABLE menu_opciones (
    ...
    nivel INT NOT NULL,
    CONSTRAINT fk_menu_padre FOREIGN KEY (id_padre) REFERENCES menu_opciones (id) ON DELETE CASCADE
);


-- Insertar opciones del menú de nivel 1
INSERT INTO menu_opciones (nombre, url, id_padre, posicion, nivel) VALUES
('Home', '#', NULL, 1, 1),
('Features', '#', NULL, 2, 1),
('Pricing', '#', NULL, 3, 1),
('Dropdown link', '#', NULL, 4, 1);

-- Insertar opciones del menú de nivel 2 (submenú de 'Dropdown link')
INSERT INTO menu_opciones (nombre, url, id_padre, posicion, nivel) VALUES
('Usuarios', '#', 4, 1, 2),
('Menu', '#', 4, 2, 2),
('Something else here', '#', 4, 3, 2);
...
--PERMISOS PRUEBA
-- Permiso para la opción "Home"
INSERT INTO permisos (permiso, id_Menu, codigo_Permiso)
VALUES ('verHome', 1, 'VER_H');

-- Permiso para la opción "Features"
INSERT INTO permisos (permiso, id_Menu, codigo_Permiso)
VALUES ('editarFeatures', 2, 'EDT_F');

-- Permiso para la opción "Pricing"
INSERT INTO permisos (permiso, id_Menu, codigo_Permiso)
VALUES ('verPricing', 3, 'VER_P');

-- Permiso para la opción "Dropdown link"
INSERT INTO permisos (permiso, id_Menu, codigo_Permiso)
VALUES ('accesoDropdown', 4, 'ACC_DD');

-- Permiso para la opción "Usuarios" (hijo de "Dropdown link")
INSERT INTO permisos (permiso, id_Menu, codigo_Permiso)
VALUES ('gestionarUsuarios', 5, 'GST_U');

-- Permiso adicional para la opción "Menu"
INSERT INTO permisos (permiso, id_Menu, codigo_Permiso)
VALUES ('editarMenu', 6, 'EDT_M');

-- Permiso para la opción "Something else here" (hijo de "Dropdown link")
INSERT INTO permisos (permiso, id_Menu, codigo_Permiso)
VALUES ('verSomethingElse', 7, 'VER_SE');
